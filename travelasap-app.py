...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # configure window
        self.title("travelASAP - info o zájezdech")
        ...
        self.sidebar_button_1 = customtkinter.CTkButton(
            self.sidebar_frame,
            text="Načti Hity týdne",
            command=self.get_list_of_hits,
        )
        ...
        self.switch_1 = customtkinter.CTkSwitch(
            master=self.checkbox_slider_frame, command=lambda: print(
                "switch 1 toggle")
        )
    ...
    def get_list_of_hits(self):
        print("Načítám Hity týdne z admina travelASAPu...")
        items["items"] = get_items_from_admin()
        print(f"Načteno {len(items['items'])} zájezdů")
        self.textbox.delete(0)
        self.textbox.insert(0, str(items["items"]))
